...
export const TOOLS = [
  ...
  { id: 'protect', name: 'Protect PDF (hint only)', desc: 'Add local hint label — NOT encryption. Anyone can still open it.', cat: 'PDF', accept: '.pdf,application/pdf' },
  ...
  { id: 'pdf-unlock-view', name: 'Unlock / View PDF (know password)', desc: 'Remove password only if you know it. No cracking.', cat: 'Security', accept: '.pdf,application/pdf', multiple: false, keywords: ['unlock', 'decrypt', 'password', 'remove password', 'view'], synonyms: ['decrypt pdf', 'remove password', 'open locked pdf'] },
